...
// Verification API Endpoint (Strictly Supports Batch Number & QR/Barcode Hash)
  ...
  try {
    ...
    if (!rawInput || rawInput.length < 2) {
      return res.status(404).json({
        ...
        message: "Invalid or too short batch number entered."
      });
    }
    ...
    // Batch number ya qr_hash mein match dhoondein
    ...
    return res.json({
      ...
      data: {
        medicine_name: found.medicine_name,
        brand_name: found.brand_name,
        batch_number: found.batch_number || targetBatch,
